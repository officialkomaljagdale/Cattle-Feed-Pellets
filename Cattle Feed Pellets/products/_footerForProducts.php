...
<body>
        <div class="row" id="">
            ...
            <div class="col-lg-4">
                <br>
                <center>
                    <h3 class=" fw-bold " data-aos="flip-up">Quick Enquiry</h3> <br>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quod, unde!</p>
                    <a href="#buttoncardServiceslearnMore"><button type="submit" class="btn btn-outline-dark">Enquiry</button></a>
                </center>
            </div>
        </div>
    </div>
