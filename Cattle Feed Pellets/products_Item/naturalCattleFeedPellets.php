...
<head>
    ...
    <title>Natural Cattle Feed Pellets</title>
</head>
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/photos/bowl-of-pelleted-compound-feed-picture-id1287642844?k=20&m=1287642844&s=612x612&w=0&h=LZ1hK7Mez_zqEODpG3xH6GEz5dDT1TXDLV1_D5xHthA=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Natural Cattle Feed Pellets</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        ...
                        <div class="flex border-t border-gray-200 py-2">
                            ...
                            <span class="ml-auto text-gray-900">Animal Food, Cattle Feed</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
