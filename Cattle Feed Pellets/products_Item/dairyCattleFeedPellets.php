...
<head>
    ...
    <title>Dairy Cattle Feed Pellets</title>
</head>
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/photos/pelleted-compound-feed-for-cattle-isolated-on-white-background-picture-id876874056?k=20&m=876874056&s=612x612&w=0&h=PvXUIpS4-YrtrwlRPF1zwjrxEfq66oJJRVXWtCXCCE0=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Dairy Cattle Feed Pellets</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        ...
                        <div class="flex border-t border-gray-200 py-2">
                            ...
                            <span class="ml-auto text-gray-900">Jute Bags, Loose, Plastic Pouch, PP Bags</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Pack Size (Kg) </span>
                            <span class="ml-auto text-gray-900">50 Kg</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Proteins</span>
                            <span class="ml-auto text-gray-900">2.96%</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Fat/ Oil Content </span>
                            <span class="ml-auto text-gray-900">0.73 %</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Fiber</span>
                            <span class="ml-auto text-gray-900">9.02 %</span>
                        </div>
                    </div>
