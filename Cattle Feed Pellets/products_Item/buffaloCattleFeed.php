...
<head>
    ...
    <title>Buffalo Cattle Feed</title>
</head>
        ...
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Buffalo Cattle Feed</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        ...
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Crude Fiber</span>
                            <span class="ml-auto text-gray-900">7.3%</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Type</span>
                            <span class="ml-auto text-gray-900">Pure</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Style</span>
                            <span class="ml-auto text-gray-900">Dried</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Crude Protein </span>
                            <span class="ml-auto text-gray-900">13.3%</span>
                        </div>
                    </div>

                    <div class="flex">
                        <span class="title-font font-medium text-2xl text-gray-900">₹18.00 - 26.00 / Kilogram</span>
