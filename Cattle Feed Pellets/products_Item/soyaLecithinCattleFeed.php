...
<head>
    ...
    <title>Soya Lecithin Cattle Feed</title>
</head>
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/photos/pelleted-compound-feed-isolated-on-white-background-wheatfeed-pellets-picture-id912867412?k=20&m=912867412&s=612x612&w=0&h=lKjBbO4SjLUfxruHNQL4QL9wMigq0ugQ0CsNMwkYsPE=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">Cattle Feed</h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Soya Lecithin Cattle Feed</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        ...
                        <div class="flex border-t border-gray-200 py-2">
                            ...
                            <span class="ml-auto text-gray-900">Loose, Plastic Pouch, PP Bags</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Moisture</span>
                            <span class="ml-auto text-gray-900">0. 8% Max</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Toluene Insoluble</span>
                            <span class="ml-auto text-gray-900">0. 31% Max</span>
                        </div>
                    </div>
