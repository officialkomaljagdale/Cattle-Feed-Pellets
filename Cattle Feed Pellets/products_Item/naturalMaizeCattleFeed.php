...
<head>
    ...
    <title>Natural Maize Cattle Feed</title>
</head>
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/photos/overflowing-maize-seeds-picture-id170215019?k=20&m=170215019&s=612x612&w=0&h=4Jg43c_pAzSpYj7IDogFUy45DlonmxLXQo6g5DLZQDA=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Natural Maize Cattle Feed</h1>
                    <div class="flex mb-4">
