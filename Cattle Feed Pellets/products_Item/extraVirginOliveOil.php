    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/photos/olive-oil-and-olives-isolated-on-reflective-white-background-picture-id1210564532?k=20&m=1210564532&s=612x612&w=0&h=VAjpSXUJjkR_xYeXkY0vbXc4cWT1oDrpbUdT-8lwGuM=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">Oil</h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Extra Virgin Olive Oil</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        <div class="flex border-t border-gray-200 py-2">
                            ...
                            <span class="ml-auto text-gray-900">Manufacturer, Supplier, Retailer</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Feature</span>
                            <span class="ml-auto text-gray-900">100% Pure & Natural Virgin Coldpressed Coconut Kernel Oil, Certified Usda Organic. Gluten Free. Non-gmo. Cold Processed Centrifuged Extracted. Highest Quality, Ideal For Dull Skin And Hair</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Packaging Type </span>
                            <span class="ml-auto text-gray-900">Glass Bottle, Mason Jar, Plastic Bottle</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Packaging Size </span>
                            <span class="ml-auto text-gray-900">100gm, 200g</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Best Before </span>
                            <span class="ml-auto text-gray-900">1 Year</span>
                        </div>
                    </div>

                    <div class="flex">
                        <span class="title-font font-medium text-2xl text-gray-900">₹0.0</span>
