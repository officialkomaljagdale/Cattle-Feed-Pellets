...
<head>
    ...
    <title>High Protein Maize Oil Cake</title>
</head>
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/photos/corn-and-corn-oil-on-white-picture-id1333161780?k=20&m=1333161780&s=612x612&w=0&h=hOE6nHeFVNND05KmM4LWtea2N9_j_uKMK_iHxJAxlDI=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">Maize Oil Cake</h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">High Protein Maize Oil Cake</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Cultivation Type</span>
                            <span class="ml-auto text-gray-900">Organic</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                        ...
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Processing Type</span>
                            <span class="ml-auto text-gray-900">Blended</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Packaging</span>
                            <span class="ml-auto text-gray-900">Plastic Pouch</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Speciality</span>
                            <span class="ml-auto text-gray-900">High In Protein, No Artificial Flavour, No Preservatives</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Proteins</span>
                            <span class="ml-auto text-gray-900">15% to 18%</span>
                        </div>
                    </div>
