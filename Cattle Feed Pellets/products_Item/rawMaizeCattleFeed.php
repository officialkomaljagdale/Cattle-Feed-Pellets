...
<head>
    ...
    <title>Raw Maize Cattle Feed</title>
</head>
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/photos/corn-grains-in-a-dropped-can-on-the-table-picture-id692192426?k=20&m=692192426&s=612x612&w=0&h=xK1P0_JgCFzzYTtaOP5ViEvMPckEJNR9o01D2B_77AA=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">Maize Cattle Feed</h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Raw Maize Cattle Feed</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        ...
                        <div class="flex border-t border-gray-200 py-2">
                            ...
                            <span class="ml-auto text-gray-900">18-20%</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Broken seeds</span>
                            <span class="ml-auto text-gray-900">Less than 5%</span>
                        </div>
                    </div>
