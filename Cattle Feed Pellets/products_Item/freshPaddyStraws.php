...
<head>
    ...
    <title>Fresh Paddy Straws</title>
</head>
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/photos/pile-of-hay-isolated-on-white-background-picture-id1383313037?k=20&m=1383313037&s=612x612&w=0&h=TDHZ2vwkk84pYt7dulcAdPd53SwXEpYT_9_xXEuCtX8=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">Paddy Straws</h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Fresh Paddy Straws</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        <div class="flex border-t border-gray-200 py-2">
                            ...
                            <span class="ml-auto text-gray-900">Golden Brown</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Bales Size </span>
                            <span class="ml-auto text-gray-900">4 Feet By 3 Feet By 2 Feet</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Moisture Level </span>
                            <span class="ml-auto text-gray-900">15-20%</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Shelf Life </span>
                            <span class="ml-auto text-gray-900">4-5 Years</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Packaging Type </span>
                            <span class="ml-auto text-gray-900">Roll</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Material</span>
                            <span class="ml-auto text-gray-900">Paddy</span>
                        </div>
                    </div>
