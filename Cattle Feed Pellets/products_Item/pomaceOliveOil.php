    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/vectors/realistic-oil-bottles-different-shape-with-lid-set-vector-liquid-vector-id1355089553?k=20&m=1355089553&s=612x612&w=0&h=wtNsD_qZKQrn2I3qizW8WiBYHuCTjnZOsOGpIFsxJpg=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Pomace Olive Oil</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        ...
                        <div class="flex border-t border-gray-200 py-2">
                            ...
                            <span class="ml-auto text-gray-900">CE Certified ISO 9001:2008</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Form</span>
                            <span class="ml-auto text-gray-900">Liquid</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Feature</span>
                            <span class="ml-auto text-gray-900">Fine Purity, Good Quality</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Packaging Size </span>
                            <span class="ml-auto text-gray-900">100ml, 250ml</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Grade</span>
                            <span class="ml-auto text-gray-900">99.99+</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Low prices </span>
                            <span class="ml-auto text-gray-900">Quality</span>
                        </div>
                    </div>

                    <div class="flex">
                        <span class="title-font font-medium text-2xl text-gray-900">₹ 265.00 - 610.00 / Litre</span>
