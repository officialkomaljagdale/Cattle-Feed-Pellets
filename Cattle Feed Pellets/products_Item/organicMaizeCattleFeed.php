...
<head>
    ...
    <title>Organic Maize Cattle Feed</title>
</head>
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://media.istockphoto.com/photos/corn-grains-in-a-can-on-the-table-picture-id692192524?k=20&m=692192524&s=612x612&w=0&h=ZFQ5vS9SROE9_jxMCv0X0ZSW2iYq6DijNdLnX-g6Mto=" width="400" height="400">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" id="modalEnquirySubmit">
                    ...
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Organic Maize Cattle Feed</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="table">
                        ...
                        <div class="flex border-t border-gray-200 py-2">
                            ...
                            <span class="ml-auto text-gray-900">Loose, Plastic Pouch</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
                            <span class="text-gray-500">Speciality</span>
                            <span class="ml-auto text-gray-900">No Artificial Flavour</span>
                        </div>
                        <div class="flex border-t border-gray-200 py-2">
